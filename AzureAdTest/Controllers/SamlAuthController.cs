...
namespace AzureAdTest.Controllers
{
    ...
    public class SamlAuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            return Ok($"Hi {authenticateResult.Principal.FindFirst(ClaimTypes.GivenName)?.Value.ToString()} {authenticateResult.Principal.FindFirst(ClaimTypes.Surname)?.Value.ToString()}");
        }
